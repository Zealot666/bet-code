...
def get_one_match(tul):
    ...
    try:
            ...
            if "滚" in td.text():
                for a in td.parent().items():
                    ...
                    try:
                        ...
                        if daxiao_num(info[3]) - sum1 == 0.5 and float(info[0]) >= 45:
                            yapan.append(info)
                    except Exception as ex:
                        pass
        ...
        col["lastTime08"] = info[0]
        col["lastBifeng08"] = info[1]
        col["masterOdd_End" + "_" + "08" + "_" + tul[6]] = float(info[2])
        col["pankouOdd_End" + "_" + "08" + "_" + tul[6]] = (info[3])
        col["guestOdd_End" + "_" + "08" + "_" + tul[6]] = float(info[4])
            ...
            if "滚" in td.text():
                for a in td.parent().items():
                    ...
                    try:
                        ...
                        if daxiao_num(info[3]) - sum1 == 0.5 and float(info[2]) >= 1.00 and float(info[0]) >= 45:
                            yapan.append(info)
                    except Exception as ex:
                        pass
        ...
        for ta in [15,20,25,30,35,40,50,55,60,65,70,75]:
            list65 = []
            for i in yapan:
                try:
                    if int(i[0]) == ta:
