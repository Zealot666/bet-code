...
col_daxiao = db["win007Lastv1006-4"]
...
def get_one_match(tul):
    ...
    try:
        ...
        # col["lastBifeng60"] = info[1]
        # col["masterOdd_End" + "_" + "602" + "_" + tul[6]] = float(info[2])
        # col["pankouOdd_End" + "_" + "602" + "_" + tul[6]] = (info[3])
        # col["guestOdd_End" + "_" + "602" + "_" + tul[6]] = float(info[4])
        ...
        # info = list65[len(list65)-1]
        # col["lastBifeng752"] = info[1]
        # col["masterOdd_End" + "_" + "7522" + "_" + tul[6]] = float(info[2])
        # col["pankouOdd_End" + "_" + "7522" + "_" + tul[6]] = (info[3])
        # col["guestOdd_End" + "_" + "7522" + "_" + tul[6]] = float(info[4])
...
if __name__ == '__main__':
    ...
    timeList += get_timeList(2023, 1, 7)
