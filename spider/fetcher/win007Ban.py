...
col_oupei = db["win007daxiaoZaoBan"]
...
def get_html(tul, typeA):
    ...
    while retry_count > 0:
        url = "http://vip.win007.com/OverDown_n.aspx?id=" + tul[0] +"&t=1&l=0"
        try:
...
def get_one_match(tul):
    ...
    try:
        ...
        def getComCol(col, company, startInfo, entInfo):
            col["masterOdd_Start" + "_" + "Ban" + "_" + company] = float(startInfo[0])
            col["pankou_Start" + "_" + "Ban" + "_" + company] = (startInfo[1])
            col["guestOdd_Start" + "_" + "Ban" + "_" + company] = float(startInfo[2])
            col["masterOdd_End" + "_" + "Ban" + "_" + company] = float(entInfo[0])
            col["pankouOdd_End" + "_" + "Ban" + "_" + company] = (entInfo[1])
            col["guestOdd_End" + "_" + "Ban" + "_" + company] = float(entInfo[2])
            return col
...
if __name__ == '__main__':
    ...
    # timeList += get_timeList(2021, 10, 11)
