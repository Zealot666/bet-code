...
col_daxiao = db["win007Lastv1006-5"]
...
def get_one_match(tul):
    ...
    try:
            ...
            if "滚" in td.text():
                for a in td.parent().items():
                    ...
                    try:
                        ...
                        if daxiao_num(info[3]) - sum1 == 0.75 and float(info[0]) >= float(col['lastTime']):
                            yapan.append(info)
                    except Exception as ex:
                        pass
        ...
        col["lastTime758"] = info[0]
        col["lastBifeng758"] = info[1]
        col["masterOdd_End" + "_" + "758" + "_" + tul[6]] = float(info[2])
        col["pankouOdd_End" + "_" + "758" + "_" + tul[6]] = (info[3])
        col["guestOdd_End" + "_" + "758" + "_" + tul[6]] = float(info[4])
            ...
            if "滚" in td.text():
                for a in td.parent().items():
                    ...
                    try:
                        ...
                        if daxiao_num(info[3]) - sum1 == 0.75 and float(info[2]) >= 1.00 and float(info[0]) >= float(col['lastTime758']) \
                            and daxiao_num(info[3]) >= daxiao_num(col['pankouOdd_End_758_3']):
                            yapan.append(info)
                    except Exception as ex:
                        pass
        ...
        col["lastTime751"] = info[0]
        col["lastBifeng751"] = info[1]
        col["masterOdd_End" + "_" + "751" + "_" + tul[6]] = float(info[2])
        col["pankouOdd_End" + "_" + "751" + "_" + tul[6]] = (info[3])
        col["guestOdd_End" + "_" + "751" + "_" + tul[6]] = float(info[4])
            ...
            if "滚" in td.text():
                for a in td.parent().items():
                    ...
                    try:
                        ...
                        if daxiao_num(info[3]) - sum1 == 0.5 and float(info[0]) >= float(col['lastTime751']):
                            yapan.append(info)
                    except Exception as ex:
                        pass
        ...
        for ta in [50,55,60,65,70]:
            ...
            for i in yapan:
                try:
                    ...
                    pass
            info = list65[0]
            col["lastBifeng"+str(ta)] = info[1]
            col["masterOdd_End" + "_" +str(ta) + "_" + tul[6]] = float(info[2])
            col["pankouOdd_End" + "_" +str(ta) + "_" + tul[6]] = (info[3])
            col["guestOdd_End" + "_" +str(ta) + "_" + tul[6]] = float(info[4])

        print("len130", len(col))

        if len(col) >= 29 and num == len(numMap) \
