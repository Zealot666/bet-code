...
def get_html(tul, typeA):
    ...
    proxies = {"http": "http://{}".format(proxy), "https": "https://{}".format(proxy)}
    while retry_count > 0:
        url = "http://vip.win007.com/changeDetail/overunder.aspx?id=" + tul[0] + "&companyid=3&l=0"
        if typeA == "yapan":
            url = "http://vip.win007.com/changeDetail/handicap.aspx?id=" + tul[0] + "&companyid=3&l=0"
        if typeA == "oupei":
            url = "http://vip.win007.com/changeDetail/1x2.aspx?id=" + tul[0] + "&companyid=3&l=0"
        try:
    ...
    try:
        ...
        for i in xiaList:
            try:
                ...
                pass
        info = list65[0]
        col["lastBifeng65"] = info[1]
        col["masterOdd_End" + "_" + "65" + "_" + tul[6]] = float(info[2])
        col["pankouOdd_End" + "_" + "65" + "_" + tul[6]] = (info[3])
        col["guestOdd_End" + "_" + "65" + "_" + tul[6]] = float(info[4])
        ...
        for i in xiaList:
            try:
                ...
                pass
        info = list65[len(list65) - 1]
        col["lastBifeng80"] = info[1]
        col["masterOdd_End" + "_" + "80" + "_" + tul[6]] = float(info[2])
        col["pankouOdd_End" + "_" + "80" + "_" + tul[6]] = (info[3])
        col["guestOdd_End" + "_" + "80" + "_" + tul[6]] = float(info[4])

        print("AAAABBBB", len(col))
        if len(col) >= 24:
