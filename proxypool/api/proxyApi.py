...
api_list = [
    {"url": "/get", "params": "type: ''http'|''", "desc": "get a proxy"},
    {"url": "/pop", "params": "", "desc": "get and delete a proxy"},
    {"url": "/delete", "params": "proxy: 'e.g. 127.0.0.1:8080'", "desc": "delete an unable proxy"},
    {"url": "/all", "params": "type: ''http'|''", "desc": "get all proxy from proxy pool"},
...
@app.route('/get/')
def get():
    https = request.args.get("type", "").lower() == 'http'
...
def runFlask():
    if platform.system() == "Windows":
        app.run(host=conf.serverHost, port=5010, threaded=True)
    else:
